...
# Custom CSS: Cyberpunk Aesthetic (Neon Cyan, Pink/Magenta & Ultra Dark)
st.markdown(
    """
    <style>
    ...
    /* 2. Cyberpunk Logo & Home Click Button */
    div.btn-home-logo > button {
    ...
    div.btn-home-logo > button:hover {
        background: transparent !important;
        border: none !important;
        box-shadow: none !important;
    }
    ...
    .cp-brand-container:hover {
        border-color: #00F3FF;
        box-shadow: 0 0 20px rgba(0, 243, 255, 0.5), inset 0 0 12px rgba(0, 243, 255, 0.2);
    }
...
with col_brand:
    # Logo + Brand yang bisa diklik untuk ke Home
    st.markdown('<div class="btn-home-logo">', unsafe_allow_html=True)
    if st.button(
        """
        <div class="cp-brand-container">
            <div class="cp-logo-box">𝙭𝙌</div>
            <div>
                <div class="cp-brand-title">Z - QUANT</div>
                <div class="cp-brand-sub">// QUANTITATIVE_SCREENER_SYSTEM</div>
            </div>
        </div>
        """,
        key="btn_go_home",
