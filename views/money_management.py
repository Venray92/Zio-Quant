...
# ==============================================================================
st.set_page_config(
    page_title="Cyberpunk Money Management",
    page_icon="⚡",
    layout="wide",
...
# Layout Input Form & Selectbox (Tes Tanda Panah Dropdown)
...
with col_left:
    ...
    amount = st.number_input("Jumlah Alokasi ($):", min_value=10, value=1000, step=50)
    
    if st.button("EXECUTE TRANSACTION"):
        st.success(f"Order {order_type} untuk {asset_type} sebesar ${amount} berhasil!")
